...
public class TracingConfiguration extends WebMvcConfigurerAdapter {
  ...
  @Bean Sender sender() {
    /* endpoint 从https://tracing-analysis.console.aliyun.com/ 获取zipking网关(endpoint)
  ...
  @Bean Tracing tracing(@Value("${zipkin.service:brave-webmvc4-example}") String serviceName) {
